...
fun RegisterRequest.toUser(passwordEncoder: PasswordEncoder) =
    User(
...
fun RecipeIngredient.toRecipeIngredientDto() =
    RecipeIngredientDto(
...
private fun MealPlanRecipe.toMealPlanRecipeDto() =
    MealPlanRecipeDto(
